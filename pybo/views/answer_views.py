...
from flask import Blueprint, url_for, request, render_template, g, session, flash
...
def create(question_id):
    ...
    if form.validate_on_submit():
        ...
        answer = Answer(content=content, create_date=datetime.now(), user_id=session.get('user_id'))
